...
const ActionButton = styled(motion.button)<{ $variant: 'like' | 'dislike' }>`
  ...
  box-shadow: 
    ...
    0 2px 10px ${props => props.$variant === 'like' ? 'rgba(16, 185, 129, 0.3)' : 'rgba(239, 68, 68, 0.3)'};
  transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
  ...
  &:hover {
    ...
    box-shadow: 
      ...
      0 4px 15px ${props => props.$variant === 'like' ? 'rgba(16, 185, 129, 0.4)' : 'rgba(239, 68, 68, 0.4)'};
  }
`;
        ...
        const mapped = (data.profiles || data).map((item: any, idx: number) => {
          if (userRole === 'startup') {
            ...
            return {
              ...
              image: item.avatar || item.image || 'https://randomuser.me/api/portraits/men/1.jpg',
              investmentFocus: Array.isArray(item.investmentFocus)
                ? item.investmentFocus
                : (typeof item.investmentFocus === 'string' && item.investmentFocus.length > 0
                    ? [item.investmentFocus]
                    : []),
            ...
            return {
              ...
              image: item.logo || item.image || 'https://source.unsplash.com/400x300/?startup',
              stage: item.stage || '',
        ...
        <div className="relative z-10 text-center">
          ...
          >
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <GradientText className="text-5xl font-bold">All Caught Up!</GradientText>
              <motion.div
                initial={{ scale: 0, rotate: 180 }}
                animate={{ scale: 1, rotate: 0 }}
            ...
            >
              You've seen all available {userRole === 'startup' ? 'investors' : 'startups'}. Check back later for new opportunities.
            </motion.p>
          </motion.div>
